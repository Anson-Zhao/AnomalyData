...
const queryDB = serverConfig.Query_db;
...
const con_ESP2 = mysql.createConnection(serverConfig.commondb_connection);
...
con_ESP2.query('USE ' + serverConfig.Query_db); // Locate Schema for tables
...
module.exports = function (app, passport) {
    ...
    app.get('/homepageLI', isLoggedIn, function (req, res) {
        ...
        con_ESP2.query(myStat + state, [req.user.username, req.user.username], (err, results) => {
    ...
    app.get('/position',function (req,res) {
        ...
        con_ESP2.query('SELECT LayerName, Longitude, Latitude, Altitude, ThirdLayer FROM LayerMenu WHERE LayerName = ?', parsedLayers[0], function (err, results) {
            if (err) {
                console.log(err);
    ...
    app.get('/csPK', function(req, res) {
        res.setHeader("Access-Control-Allow-Origin", "*"); // Allow cross domain header
        let select = "SELECT * FROM LayerMenu WHERE LayerType = 'CS_PKLayer'";
        con_ESP2.query( select, function (err, result) {
            if (err) { throw err }
    ...
    app.get('/currentLayer',function (req,res) {
        ...
        con_ESP2.query(queryState, thirdlayer, function (err, results) {
            if (err) {
                console.log(err);
    ...
    app.get('/firstLayer', function (req, res) {
        ...
        con_ESP2.query("SELECT FirstLayer FROM LayerMenu WHERE Status ='Approved' GROUP BY FirstLayer ", function (err, result) {
    ...
    app.get('/secondLayer', function (req, res) {
        ...
        con_ESP2.query("SELECT SecondLayer,FirstLayer FROM LayerMenu WHERE Status ='Approved' and FirstLayer =? GROUP BY SecondLayer", firstlayerValue ,function (err, result) {
            // let JSONresult = JSON.stringify(result, null, "\t");
            if (err) { throw err } else {
                res.json(result);
            }
    ...
    app.get('/thirdLayer', function (req, res) {
        ...
        con_ESP2.query("SELECT LayerType,SecondLayer,ThirdLayer,CityName,StateName,CountryName, GROUP_CONCAT(LayerName) as LayerName FROM LayerMenu WHERE Status ='Approved' and SecondLayer =? GROUP BY ThirdLayer,CityName,StateName,CountryName,SecondLayer,LayerType", secondLayerValue ,function (err, result) {
            // let JSONresult = JSON.stringify(result, null, "\t");
            //All layer?
            //WHERE cityname = ''?
            if (err) { throw err } else {
    ...
    app.get('/mrdsDataP', function (req, res) {
        ...
        con_ESP2.query(statement, function (err, result) {
            if (err) throw err;
    ...
    app.get('/mrdsData', function (req, res) {
        ...
        con_ESP2.query(statement, function (err, results, fields) {
            if (err) {
                console.log(err);
                res.json({"error": true, "message": "An unexpected error occurred !"});
            } else {
    ...
    app.post('/kauth', function (req, res) {
        ...
        con_ESP2.query(myStat, function (err, result) {
    ...
    app.get('/reset/:token', function (req, res) {
        ...
        con_ESP2.query(myStat, function (err, user) {
            dateNtime();
            ...
            function (done) {
                ...
                con_ESP2.query(myStat, function (err, user) {
                    ...
                    if (!user) {
                        ...
                        con_ESP2.query(passReset, function (err, rows) {
                            if (err) {
                                console.log(err);
    ...
    app.get('/userhome', isLoggedIn, function (req, res) {
        ...
        con_ESP2.query(myStat + state2, function (err, results) {
            // console.log("Users: ");
            // console.log(results);
    ...
    //     res.setHeader("Access-Control-Allow-Origin", "*"); // Allow cross domain header
    //     con_ESP2.query(SQLstatement, Value, function (err, rows) {
    //         if (err) {
    //             console.log(err);
    ...
    app.get('/recoverRow', isLoggedIn, function (req, res) {
        ...
        for(let i = 0; i < pictureStr.length; i++) {//the length of pictureStr and Prior_status may not be the same since some layer may not have picture with it
            ...
            if (transactionPrStatusStr[i] === 'Pending') {
                ...
                con_ESP2.query(statementpractice, [Pending_Dir, layerNameStr[i]], (err, results)=> {
                    if(i ===pictureStr.length - 1){
                        if (err) {
                            throw err;
                            // console.log(err);
            ...
            if(transactionPrStatusStr[i] === 'Approved'){
                ...
                con_ESP2.query(statement1+statement2, function (err, results) {
                    if(i === pictureStr.length - 1){
            ...
            if(transactionPrStatusStr[i] === 'Rejected'){
                ...
                con_ESP2.query(statement+ statement3, [layerNameStr[i],layerNameStr[i]] , function (err, results) {
    ...
    app.get('/dataHistory', isLoggedIn, function (req, res) {
        ...
        con_ESP2.query(state2, function (err, results, fields) {
            // console.log(results);
    ...
    app.get('/disapprove',function (req,res) { //maybe this is the successful server side code for record deletion; should ask Mr.Anson
        ...
        for (let i = 0; i < transactionID.length; i++) {
            ...
            con_ESP2.query(statement + statement1, function (err, results) {
                if (err) throw err;
                res.json(results[i]);
            });
        }
    ...
    app.get('/filterQuery', isLoggedIn, function (req, res) {
        ...
        con_ESP2.query(sqlStat, [start, end], function(err, result){
            res.json(result);
        })
    ...
    app.get('/profile', function (req, res) {
        ...
        con_ESP2.query("SELECT * FROM UserProfile WHERE username = '" + userN + "'; SELECT question1, answer1, question2, answer2 FROM UserLogin WHERE username = '" + userN + "';", function (err, results) {
            if (err) throw err;
            res.json(results);
        })
    });
    ...
    app.post('/checkpassword',function (req,res) {
        ...
        con_ESP2.query(statement,function (err,results) {
    ...
    app.post('/userProfile', isLoggedIn, function (req, res) {
        ...
        function basicInformation() {
            ...
            con_ESP2.query(statement1, function (err, result) {
                if (err) {
    ...
    app.get('/userManagement', isLoggedIn, function (req, res) {
        ...
        con_ESP2.query(myStat + state2, function (err, results, fields) {
    ...
    app.post('/signup', function (req, res) {
        res.setHeader("Access-Control-Allow-Origin", "*"); // Allow cross domain header
        // con_ESP2.query('USE ' + serverConfig.Login_db); // Locate Login DB
        ...
        console.log(myStat);
        console.log(mylogin);
        con_ESP2.query(myStat + '' + mylogin, function (err, rows) {
    ...
    app.get('/verify/:token', function(req, res) {
        ...
        async.waterfall([
            function(done) {
                myStat = "SELECT * FROM UserLogin WHERE resetPasswordToken = '" + req.params.token + "'";
                con_ESP2.query(myStat, function(err, results) {
                    dateNtime();
    ...
    app.get('/verifyemail/:token', function(req, res) {
        ...
        async.waterfall([
            function(done) {
                ...
                con_ESP2.query(myStat + myProfile, function(err, user) {
                    if (err) {
                        console.log(err);
                        res.send("An unexpected error occurred !");
                    } else {
    ...
    app.get('/AddData', function (req, res) {
        res.setHeader("Access-Control-Allow-Origin", "*");
        con_ESP2.query('SELECT * FROM Request_Form', function (err, results) {
            if (err) throw err;
            res.json(results);
    ...
    app.post('/edituserform',function (req,res) {
        ...
        //
        //         con_ESP2.query(passAdminReset, function (err, rows) {
        //             if (err) {
        //                 console.log(err);
        //                 res.json({"error": true, "message": "Fail !"});
        //             } else {
        ...
        function basicInformation() {
            ...
            con_ESP2.query(statement1 + statement2, function (err, result) {
                if (err) throw err;
                res.json(result);
            });
        }
    ...
    app.post('/submitL', function (req, res) {
        ...
        con_ESP2.query(statement2 + statement, function (err, result) {
            if (err) {
                throw err;
            } else {
                res.json("Connected!")
    ...
    app.get('/newRequest', isLoggedIn, function (req, res) {
        ...
        con_ESP2.query(queryRID, function (err, results, fields) {
            ...
            if (err) {
                ...
                con_ESP2.query(insertRID, function (err, results, fields) {
                    if (err) {
                        console.log(err);
                    } else {
    ...
    app.get('/MainCategory', function (req, res) {
        res.setHeader("Access-Control-Allow-Origin", "*");
        con_ESP2.query("SELECT FirstLayer, SecondLayer FROM LayerCategories GROUP BY FirstLayer, SecondLayer", function (err, results) {
            if (err) throw err;
            res.json(results);
        });
    });
    ...
    app.post('/rsubmit',function (req,res) {
        ...
        if(status === "Reject"){
            con_ESP2.query(statement1 + statement2 + statement3 + statement4, function (err, result) {
                if (err) {
                    throw err;
                } else {
                    res.json("Connected!")
            ...
            con_ESP2.query(statement1 + statement2 + statement3, function (err, result) {
                if (err) {
                    throw err;
                } else {
                    res.json("Connected!")
    ...
    app.get('/SearchLayerName', function (req, res) {
        res.setHeader("Access-Control-Allow-Origin", "*");
        con_ESP2.query("SELECT LayerName FROM Request_Form", function (err, results) {
            if (err) throw err;
            res.json(results);
        });
    });
    ...
    app.get('/SearchUsername', function (req, res) {
        res.setHeader("Access-Control-Allow-Origin", "*");
        con_ESP2.query("SELECT username FROM UserLogin", function (err, results) {
            if (err) throw err;
            res.json(results);
        });
    });
    ...
    app.get('/SearchThirdLayer',function (req,res) {
        res.setHeader("Access-Control-Allow-Origin", "*");
        con_ESP2.query("SELECT ThirdLayer FROM Request_Form", function (err, results) {
            if (err) throw err;
            res.json(results);
    ...
    app.get('/approve', function (req, res) {
        ...
        for(let i = 0; i < approvepictureStr.length; i++) {
            ...
            con_ESP2.query(myState1, function (err, results) {
                if (err) throw err;
                // console.log(results);
                                        ...
                                        function (error, stdout, stderr) {
                                            ...
                                            if (error !== null) {
                                                ...
                                                setTimeout( function () {
                                                    ...
                                                    con_ESP2.query(myState2 + myState3, function (err, results) {
                                                        if (err) {
                                                            throw err;
                                                        } else {
                                                            setTimeout( function () {
                                                                ...
                                                                child = exec(uploadStat3,
                                                                    function (error, stdout, stderr) {
                                                                        ...
                                                                        if (error !== null) {
                                                                            ...
                                                                            con_ESP2.query(myState4, function (err, results) {
                                                                                if (err) {
                                                                                    throw err;
                                                                                } else {
                                                                                    //res.json(results);
                                    ...
                                    child = exec(statement,
                                        function (error, stdout, stderr) {
                                            ...
                                            if (error !== null) {
                                                ...
                                                con_ESP2.query(statementNext + statementNext2 + statementNext3, function (err, results) {
                                                    if (err) {
                                                        throw err;
                                                    } else {
                                                        ...
                                                        //
                                                        //             con_ESP2.query(statementNext3, function (err, results) {
                                                        //                 if (err) {
                                                        //                     throw err;
                                                        //                 } else {
                                                        //                     //res.json(results);
    ...
    app.post('/replace', function (req, res) { //puts everything from a request form into LayerMenu once it has been approved
        ...
        if(result[3][1] === "other"){
            ...
            con_ESP2.query(statement1 + statement + statement2 + statement3, function (err, result) {
                console.log(statement);
                if (err) {
                    throw err;
                } else {
    ...
    app.get('/reject',function (req,res) {
        ...
        con_ESP2.query(statement + statement2,function (err,results) {
            if (err) {
                console.log(err);
    ...
    app.post('/add', function(req, res) {
        ...
        con_ESP2.query(initial, function(err, result){
            if(err){
                console.log(err);
            } else if(result.length < 1){
                res.json('There were no logs with that username please make sure you have entered it correctly');
            } else {
                con_ESP2.query(statement, [min, diff], function(err, result){
                    if(err){
                        console.log(err);
                    } else {
                        console.log('cool');
                        con_ESP2.query(statement1, min, function(err){
                            if(err){
                                console.log(err);
                            } else {
                                console.log('my guy');
    ...
    app.post('/inTime', function(req, res) {
        ...
        let statement = "INSERT INTO timelog(username, logDate, inTime, outTime, timeLeft) VALUES ('" + req.user.username + "', (?), (?), NULL,'" + req.user.minutesLeft + "' )"
        con_ESP2.query(statement, [bruh, lmao], function(err){
            if (err){
                console.log(err);
            } else {
                console.log("Cool");
    ...
    app.post('/time', async function(req, res){
        ...
        //console.log(time);
        //console.log(lol);
        let statement = "UPDATE timelog SET outTime = (?) WHERE outTime IS NULL AND logDate = (?) AND username = '" + req.user.username + "';"
        let statement1 = "SELECT inTime FROM timelog WHERE outTime IS NULL AND logDate = (?) AND username = '" + req.user.username + "';"
        let update = "UPDATE UserLogin SET minutesLeft = (minutesLeft - (?)) WHERE username = '" + req.user.username + "';"
        let diff = "UPDATE timelog SET timeDiff = timediff((?), (?)) WHERE outTime IS NULL AND logDate = (?) AND username = '" + req.user.username + "';"
        let diffSelect = "SELECT timeDiff FROM timelog WHERE outTime IS NULL AND logDate = (?) AND username = '" + req.user.username + "';"

        con_ESP2.query(statement1, lol, function (err, result) {
            if (err) {
                console.log(err);
            } else if (result.length == 0) {
                //res.json("error");
                ...
                con_ESP2.query(diff, [time, start, lol], function (err) {
                    if (err) {
                        console.log(err);
                    } else {
                        con_ESP2.query(diffSelect, lol, function (err, result) {
                            if (err) {
                                console.log(err);
                            } else {
                                ...
                                con_ESP2.query(update, total, function (err) {
                                    if (err) {
                                        console.log(err);
                                    } else {
                                        con_ESP2.query(statement, [time, lol], function (err) {
                                            if (err) {
                                                console.log(err);
                                            } else {
                                                res.json(stat);
    ...
    // =====================================
    // CitySmartCitySmart2 Menu Filter SECTION =======
    // =====================================

    //Country level
    app.get('/CountryList', function (req, res) {
        res.setHeader("Access-Control-Allow-Origin", "*");
        con_ESP2.query('SELECT CountryName FROM LayerMenu GROUP BY CountryName', function (err, results) {
            if (err) throw err;
            res.json(results);
        });
    });
    ...
    app.get('/ClassName', function (req, res) {
        ...
        if (recieveCitylist === 'All Cities') {
            con_ESP2.query( my2statement , receiveStatelist, function(err, results) {
                res.json(results);
            })
        }
        else {
            con_ESP2.query("SELECT FirstLayer, SecondLayer, ThirdLayer FROM LayerMenu WHERE CityName = ? ;", recieveCitylist, function (err, results) {
                res.json(results);
    ...
    app.get('/CountryClassName', function (req, res) {
        ...
        con_ESP2.query("SELECT FirstLayer, SecondLayer, ThirdLayer FROM LayerMenu WHERE CountryName = ? ;", recieveCountrylist, function (err, results) {
            res.json(results);
        });
    });
    //state level
    ...
    app.get('/StateList', function (req, res) {
        ...
        stat = "Kodiak";
        con_ESP2.query("SELECT StateName FROM LayerMenu WHERE StateName <> 'All States' AND CountryName = ? GROUP BY StateName", recieveCountrylist, function (err, results, fields) {
            res.json(results);
        });
    });
    //city level
    app.get('/CityList', function (req, res) {
        ...
        con_ESP2.query("SELECT CityName FROM LayerMenu WHERE CityName <> 'All Cities' AND StateName = ? GROUP BY CityName" , recieveCitylist, function (err, results, fields) {
            res.json(results);
        });
    });
    ...
    app.get('/layerRequestContinent',function(req,res){
        res.setHeader("Access-Control-Allow-Origin", "*");
        con_ESP2.query("SELECT Continent,Continent_name  FROM Country group by Continent,Continent_name", function (err, results) {
            // console.log(results);
            if (err) throw err;
            res.json(results);
        });
    ...
    app.get('/layerRequestCountry',function(req,res){
        ...
        con_ESP2.query("SELECT Country_name FROM Country WHERE Continent = ?", recieveCountryData, function (err, results) {
            console.log(results);
            if (err) throw err;
            res.json(results);
        });
...
//AddData in table
    ...
    // app.get('/EditData', function (req, res) {
    //     res.setHeader("Access-Control-Allow-Origin", "*");
    //     con_ESP2.query("SELECT Full Name, Address Line 1, Address Line 2, City, State/Province/Region, Postal Code/ZIP, Country, Email, Phone Number, Layer Name, Layer Category, Layer Description, Layer Uploader FROM GeneralFormDatatable", function (err, results) {
    //         if (err) throw err;
    //     })
    // });
    ...
    app.get('/SearchLayerName', function (req, res) {
        res.setHeader("Access-Control-Allow-Origin", "*");
        con_ESP2.query("SELECT ThirdLayer FROM LayerMenu", function (err, results) {
            if (err) throw err;
            res.json(results);
    ...
    app.get('/layername', function (req, res) {
        res.setHeader("Access-Control-Allow-Origin", "*");
        con_ESP2.query("SELECT LayerName From LayerMenu", function (err, result) {
            let JSONresult = JSON.stringify(result, null, "\t");
            res.send(JSONresult);
        });
    });
    ...
    app.get('/autoMenu',function (req,res) {
        ...
        let queryState = "SELECT FirstLayer, SecondLayer, ThirdLayer, " +
            ...
            "FROM LayerMenu WHERE Status = 'Approved' and Available = 'Yes' " +
            "GROUP BY FirstLayer, SecondLayer, ThirdLayer, LayerType, CountryName, StateName, CityName";

        con_ESP2.query(queryState, function (err, results) {
            if (err) {
                console.log(err);
                res.json({"error": true, "message": "An unexpected error occurred !"});
            } else {
    ...
    app.get('/allLayerMenu', function (req, res) {
        ...
        con_ESP2.query("SELECT * From LayerMenu WHERE Status = 'Approved' and Available = 'Yes'", function (err, results) {
            if (err) {
                console.log(err);
                res.json({"error": true, "message": "An unexpected error occurred !"});
            } else {
...
// Customized Functions Below
    ...
    function dataList(sqlStatement, res) {
        ...
        con_ESP2.query(sqlStatement, function (err, results) {
    ...
    function sendToken(username, subject, text, url, res) {
        async.waterfall([
            ...
            function (token, tokenExpire, done) {
                ...
                con_ESP2.query(myStat, myVal, function (err, rows) {
